...
Module WordByWordMontgomery.
  Section with_args.
    ...
    Context (wt : nat -> Z)
            ...
            (m_enc_correct_montgomery : Z.pos m = Positional.eval sz (Z.pos r) m_enc)
            (r'_pow_correct : ((r' ^ Z.of_nat sz * Z.pos r ^ Z.of_nat sz) mod Positional.eval sz (Z.pos r) m_enc = 1)%Z)
            (* computable *)
            (r_big : Z.pos r > 1)
            (m_big : 1 < Z.pos m)
