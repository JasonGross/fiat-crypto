    ...
    Section with_counter.
      ...
      Section with_ident.
        ...
        Lemma Wf_Subst0n
          ...
          : expr.Wf e -> expr.Wf (Subst0n one incr add doing_subst should_subst e).
        ...
        Section interp.
          ...
          Section with_doing_subst.
            ...
            Lemma Interp_Subst0n {t} (e : @expr.Expr base_type ident t) (Hwf : expr.Wf e)
              : expr.Interp interp_ident (Subst0n one incr add doing_subst should_subst e) == expr.Interp interp_ident e.
