...
Section carrying_helper.
  ...
  Proof. unfold add_to_nth; intros; rewrite update_nth_sum; try ring_simplify; auto. Qed.
...
Hint Rewrite @length_carry_gen @length_carry_simple @length_carry_simple_sequence @length_make_chain @length_full_carry_chain @length_carry_simple_full : distr_length.
Hint Rewrite @nth_default_carry_gen_full : push_nth_default.
Hint Rewrite @nth_default_carry_gen using (omega || distr_length; omega) : push_nth_default.
