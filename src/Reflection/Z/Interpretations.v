...
*)
  ...
  Definition is_bounded_by {T} : interp_flat_type Syntax.interp_base_type T -> interp_flat_type interp_base_type T -> Prop
    := interp_flat_type_rel_pointwise2 (@is_bounded_by').
  ...
  Lemma MapBounds_correct_and_bounded {t}
    ...
    : forall x y,
      ...
      -> (*is_bounded_by (map_uncast_const _ (Interp (@Syntax.interp_op) e' x)) output_bounds
  ...
  Proof.
    ...
    erewrite InterpMapInterpCast. 3:eauto with wf.
    rewrite InterpSmartBound.

    Focus 2.
    { .
    { apply Wf_Linearize.
      apply Wf_SmartBound.
      apply Wf_MapInterpCast.
      2:assumption.
      eauto.
