...
Notation iunop_correct_and_bounded irop op := (inm_op_correct_and_bounded1 1 irop op) (only parsing).
Notation ibinop_correct_and_bounded irop op := (inm_op_correct_and_bounded1 2 irop op) (only parsing).
