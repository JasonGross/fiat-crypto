...
Notation correct_and_bounded_genT ropW'v ropZ_sigv
  := (let ropW' := ropW'v in
      ...
      /\ interp_type_rel_pointwise2 Relations.related_bounds (Interp (@BoundedWordW.interp_op) ropW') (Interp (@Bounds.interp_op) ropW')
...
Notation compute_bounds opW bounds
  := (Interp (@Bounds.interp_op) opW bounds)
       (only parsing).
