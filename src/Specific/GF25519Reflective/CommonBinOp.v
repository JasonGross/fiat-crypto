...
Proof.
  ...
  eapply LiftOption.lift_relation_type_pointwise2 in H0.
  eapply LiftOption.lift_relation_type_pointwise2 in H2.
  eapply LiftOption.lift_relation2_type_pointwise2 in H1.
  { setoid_rewrite Relations.lift_interp_type_rel_pointwise2_f_eq_id2 in H0.
    setoid_rewrite Relations.lift_interp_type_rel_pointwise2_f_eq_id2 in H2.
    setoid_rewrite Relations.lift_interp_type_rel_pointwise2_f_eq_id2 in H1.
    cbv [ExprBinOpT] in *.
  ...
  Check LiftOption.of'.
  unfold interp_type_rel_pointwise2, interp_type_gen_rel_pointwise2, interp_type_gen_rel_pointwise2_hetero, ExprBinOpT, Morphisms.respectful_hetero, interp_flat_type_rel_pointwise2, interp_flat_type_rel_pointwise2_gen_Prop in *.
  simpl @interp_flat_type in *.
  cbv
