...
Ltac add_sub_sig pkg :=
  Tag.update_by_tac_if_not_exists
    ...
    ltac:(fun _ => let sz := Tag.get pkg TAG.sz in
                   ...
                   let sub_sig := pose_sub_sig sz m wt coef_div_modulus sz_le_log2_m sub_sig in
                   constr:(sub_sig)).
Ltac add_opp_sig pkg :=
  Tag.update_by_tac_if_not_exists
    ...
    ltac:(fun _ => let sz := Tag.get pkg TAG.sz in
                   ...
                   let opp_sig := pose_opp_sig sz m wt coef_div_modulus sz_le_log2_m opp_sig in
                   constr:(opp_sig)).
Ltac add_mul_sig pkg :=
  Tag.update_by_tac_if_not_exists
    ...
    ltac:(fun _ => let sz := Tag.get pkg TAG.sz in
                   ...
                   let mul_sig := pose_mul_sig sz m wt s c mul_code sz_nonzero s_nonzero m_correct mul_code_correct mul_sig in
                   constr:(mul_sig)).
Ltac add_square_sig pkg :=
  Tag.update_by_tac_if_not_exists
    ...
    ltac:(fun _ => let sz := Tag.get pkg TAG.sz in
                   ...
                   let square_sig := pose_square_sig sz m wt s c square_code sz_nonzero s_nonzero m_correct square_code_correct square_sig in
                   constr:(square_sig)).
Ltac add_ring pkg :=
  Tag.update_by_tac_if_not_exists
    pkg
