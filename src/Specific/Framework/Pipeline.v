...
Ltac RBPipelineSideConditions_unfold ::=
  cbv [val
         ...
         Solinas.vm_add_patterned
         Solinas.vm_sub_patterned
         Solinas.vm_mul_patterned
         Solinas.vm_opp_patterned
         Solinas.vm_reduce_patterned
         Solinas.vm_reduce_patterned_sz_sz
         Solinas.vm_reduce_patterned_sz_1p5
         Solinas.vm_chained_carries_reduce_patterned
         Solinas.vm_karatsuba_mul_patterned
         Solinas.vm_goldilocks_mul_patterned
         Solinas.vm_freeze_patterned
