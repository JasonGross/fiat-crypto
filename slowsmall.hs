   ...
   List_rect _ _ -> (\pat ->
    case unsafeCoerce pat of {
     (,) i c ->
      case i of {
       (,) a b ->
        let {c_case = \a0 b0 c0 -> b ((,) ((,) a0 b0) c0)} in
        list_rect (a ()) (\x xs rec -> c_case x xs (\_ -> rec)) c}});
...
from_flat _ e x =
  case e of {
   ...
   Abs0 s cur_idx d f ->
    ...
    Abs s d (\v -> f' __ (add2 cur_idx (ExistT s v) x))}
...
lazy_list_rect :: (() -> a2) -> (a1 -> (([]) a1) -> (() -> a2) -> a2) ->
                  (([]) a1) -> a2
lazy_list_rect n c l =
  case l of {
   ([]) -> n ();
   (:) x xs -> c x xs (\_ -> lazy_list_rect n c xs)}
  ...
  case idc of {
   ...
   List_rect a p ->
    ...
    case unsafeCoerce nil_case_cons_case_ls of {
     Prelude.Left _ ->
      unsafeCoerce default_interp (Prod (Prod (Arrow (Type_primitive Unit) p)
        (Arrow (Prod (Prod a (List a)) (Arrow (Type_primitive Unit) p)) p))
        (List a)) p idc0 nil_case_cons_case_ls;
     Prelude.Right p0 ->
      case p0 of {
       (,) s s0 ->
        case s of {
         Prelude.Left _ ->
          unsafeCoerce default_interp (Prod (Prod (Arrow (Type_primitive
            Unit) p) (Arrow (Prod (Prod a (List a)) (Arrow (Type_primitive
            Unit) p)) p)) (List a)) p idc0 nil_case_cons_case_ls;
         Prelude.Right p1 ->
          case p1 of {
           (,) nil_case cons_case ->
            case s0 of {
             Prelude.Left _ ->
              unsafeCoerce default_interp (Prod (Prod (Arrow (Type_primitive
                Unit) p) (Arrow (Prod (Prod a (List a)) (Arrow
                (Type_primitive Unit) p)) p)) (List a)) p idc0
                nil_case_cons_case_ls;
             Prelude.Right ls ->
              lazy_list_rect (\tt -> nil_case (Prelude.Right tt))
                (\x xs rec ->
                cons_case (Prelude.Right ((,) (Prelude.Right ((,) x
                  (Prelude.Right xs))) (\_ -> rec ())))) ls}}}}});
   List_nth_default a ->
    case a of {
     Type_primitive a0 ->
      case a0 of {
...
computedPart1 =
  Abs (Type_primitive Unit) (Type_primitive Z1) (\_ -> App (Arrow (Arrow
    (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive
    Z1))) (Type_primitive Z1)) (Type_primitive Z1)) (Type_primitive Z1)
    (AppIdent (Prod (Prod (Arrow (Type_primitive Unit) (Arrow (Arrow (Arrow
    (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive
    Z1))) (Type_primitive Z1)) (Type_primitive Z1)) (Type_primitive Z1)))
    (Arrow (Prod (Type_primitive Nat0) (Arrow (Arrow (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    (Type_primitive Z1)) (Type_primitive Z1)) (Type_primitive Z1))) (Arrow
    (Arrow (Arrow (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) (Type_primitive Z1)) (Type_primitive Z1))
    (Type_primitive Z1)))) (Type_primitive Nat0)) (Arrow (Arrow (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    (Type_primitive Z1)) (Type_primitive Z1)) (Type_primitive Z1)) (Nat_rect
    (Arrow (Arrow (Arrow (Prod (Type_primitive Nat0) (Arrow (Type_primitive
    Z1) (Type_primitive Z1))) (Type_primitive Z1)) (Type_primitive Z1))
    (Type_primitive Z1))) (Pair (Prod (Arrow (Type_primitive Unit) (Arrow
    (Arrow (Arrow (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) (Type_primitive Z1)) (Type_primitive Z1))
    (Type_primitive Z1))) (Arrow (Prod (Type_primitive Nat0) (Arrow (Arrow
    (Arrow (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    ...
    (Type_primitive Z1))) (Arrow (Arrow (Arrow (Prod (Type_primitive Nat0)
    (Arrow (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive Z1))
    (Type_primitive Z1)) (Type_primitive Z1)))) (Type_primitive Nat0) (Pair
    (Arrow (Type_primitive Unit) (Arrow (Arrow (Arrow (Prod (Type_primitive
    Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive
    Z1)) (Type_primitive Z1)) (Type_primitive Z1))) (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Arrow (Arrow (Prod (Type_primitive Nat0)
    (Arrow (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive Z1))
    (Type_primitive Z1)) (Type_primitive Z1))) (Arrow (Arrow (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    (Type_primitive Z1)) (Type_primitive Z1)) (Type_primitive Z1))) (Abs
    (Type_primitive Unit) (Arrow (Arrow (Arrow (Prod (Type_primitive Nat0)
    (Arrow (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive Z1))
    (Type_primitive Z1)) (Type_primitive Z1)) (\_ -> Abs (Arrow (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    (Type_primitive Z1)) (Type_primitive Z1)) (Type_primitive Z1) (\x -> App
    (Arrow (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) (Type_primitive Z1)) (Type_primitive Z1) (Var
    (Arrow (Arrow (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) (Type_primitive Z1)) (Type_primitive Z1)) x) (Abs
    (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive
    Z1))) (Type_primitive Z1) (\x0 -> App (Type_primitive Z1) (Type_primitive
    Z1) (AppIdent (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) (Arrow (Type_primitive Z1) (Type_primitive Z1))
    (Snd (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive
    Z1))) (Var (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) x0)) (AppIdent (Type_primitive Unit)
    (Type_primitive Z1) (Primitive0 Z1 (unsafeCoerce Z0)) TT)))))) (Abs (Prod
    (Type_primitive Nat0) (Arrow (Arrow (Arrow (Prod (Type_primitive Nat0)
    (Arrow (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive Z1))
    (Type_primitive Z1)) (Type_primitive Z1))) (Arrow (Arrow (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    ...
    (Arrow (Arrow (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) (Type_primitive Z1)) (Type_primitive Z1))
    (Type_primitive Z1) (\x0 -> App (Arrow (Arrow (Prod (Type_primitive Nat0)
    (Arrow (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive Z1))
    ...
    Nat0) (Arrow (Arrow (Arrow (Prod (Type_primitive Nat0) (Arrow
    (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive Z1))
    (Type_primitive Z1)) (Type_primitive Z1))) x)) (Abs (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    (Type_primitive Z1)) (Type_primitive Z1) (\x1 -> App (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    (Type_primitive Z1)) (Type_primitive Z1) (Var (Arrow (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    (Type_primitive Z1)) (Type_primitive Z1)) x0) (Abs (Prod (Type_primitive
    Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive
    Z1) (\x2 -> App (Arrow (Type_primitive Z1) (Type_primitive Z1))
    (Type_primitive Z1) (AppIdent (Prod (Prod (Arrow (Type_primitive Unit)
    (Arrow (Arrow (Type_primitive Z1) (Type_primitive Z1)) (Type_primitive
    Z1))) (Arrow (Prod (Type_primitive Nat0) (Arrow (Arrow (Type_primitive
    Z1) (Type_primitive Z1)) (Type_primitive Z1))) (Arrow (Arrow
    (Type_primitive Z1) (Type_primitive Z1)) (Type_primitive Z1))))
    (Type_primitive Nat0)) (Arrow (Arrow (Type_primitive Z1) (Type_primitive
    Z1)) (Type_primitive Z1)) (Nat_rect (Arrow (Arrow (Type_primitive Z1)
    ...
    (Arrow (Type_primitive Z1) (Type_primitive Z1)) (Type_primitive Z1)))
    (Arrow (Prod (Type_primitive Nat0) (Arrow (Arrow (Type_primitive Z1)
    (Type_primitive Z1)) (Type_primitive Z1))) (Arrow (Arrow (Type_primitive
    Z1) (Type_primitive Z1)) (Type_primitive Z1))) (Abs (Type_primitive Unit)
    (Arrow (Arrow (Type_primitive Z1) (Type_primitive Z1)) (Type_primitive
    Z1)) (\_ -> Abs (Arrow (Type_primitive Z1) (Type_primitive Z1))
    (Type_primitive Z1) (\x3 -> App (Type_primitive Z1) (Type_primitive Z1)
    (Var (Arrow (Type_primitive Z1) (Type_primitive Z1)) x3) (AppIdent
    (Type_primitive Unit) (Type_primitive Z1) (Primitive0 Z1
    (unsafeCoerce Z0)) TT)))) (Abs (Prod (Type_primitive Nat0) (Arrow (Arrow
    (Type_primitive Z1) (Type_primitive Z1)) (Type_primitive Z1))) (Arrow
    (Arrow (Type_primitive Z1) (Type_primitive Z1)) (Type_primitive Z1))
    (\x3 -> Abs (Arrow (Type_primitive Z1) (Type_primitive Z1))
    (Type_primitive Z1) (\x4 -> App (Arrow (Type_primitive Z1)
    (Type_primitive Z1)) (Type_primitive Z1) (AppIdent (Prod (Type_primitive
    Nat0) (Arrow (Arrow (Type_primitive Z1) (Type_primitive Z1))
    (Type_primitive Z1))) (Arrow (Arrow (Type_primitive Z1) (Type_primitive
    Z1)) (Type_primitive Z1)) (Snd (Type_primitive Nat0) (Arrow (Arrow
    (Type_primitive Z1) (Type_primitive Z1)) (Type_primitive Z1))) (Var (Prod
    (Type_primitive Nat0) (Arrow (Arrow (Type_primitive Z1) (Type_primitive
    Z1)) (Type_primitive Z1))) x3)) (Abs (Type_primitive Z1) (Type_primitive
    Z1) (\_ -> App (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) (Type_primitive Z1) (Var (Arrow (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    (Type_primitive Z1)) x1) (Pair (Type_primitive Nat0) (Arrow
    (Type_primitive Z1) (Type_primitive Z1)) (AppIdent (Prod (Type_primitive
    Nat0) (Arrow (Arrow (Type_primitive Z1) (Type_primitive Z1))
    (Type_primitive Z1))) (Type_primitive Nat0) (Fst (Type_primitive Nat0)
    (Arrow (Arrow (Type_primitive Z1) (Type_primitive Z1)) (Type_primitive
    Z1))) (Var (Prod (Type_primitive Nat0) (Arrow (Arrow (Type_primitive Z1)
    (Type_primitive Z1)) (Type_primitive Z1))) x3)) (Abs (Type_primitive Z1)
    (Type_primitive Z1) (\x5 -> App (Type_primitive Z1) (Type_primitive Z1)
    (Var (Arrow (Type_primitive Z1) (Type_primitive Z1)) x4) (Var
    (Type_primitive Z1) x5)))))))))) (AppIdent (Prod (Type_primitive Nat0)
    (Arrow (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive Nat0)
    (Fst (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive
    Z1))) (Var (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) x2)))) (Abs (Type_primitive Z1) (Type_primitive Z1)
    (\x3 -> App (Type_primitive Z1) (Type_primitive Z1) (AppIdent (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    (Arrow (Type_primitive Z1) (Type_primitive Z1)) (Snd (Type_primitive
    Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1))) (Var (Prod
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1)))
    x2)) (Var (Type_primitive Z1) x3))))))))))) (AppIdent (Type_primitive
    Unit) (Type_primitive Nat0) (Primitive0 Nat0
    (unsafeCoerce (S (S (S (S (S (S (S (S (S (S O)))))))))))) TT))) (Abs
    (Arrow (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1)
    (Type_primitive Z1))) (Type_primitive Z1)) (Type_primitive Z1) (\x -> App
    (Prod (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive
    Z1))) (Type_primitive Z1) (Var (Arrow (Prod (Type_primitive Nat0) (Arrow
    (Type_primitive Z1) (Type_primitive Z1))) (Type_primitive Z1)) x) (Pair
    (Type_primitive Nat0) (Arrow (Type_primitive Z1) (Type_primitive Z1))
    (AppIdent (Type_primitive Unit) (Type_primitive Nat0) (Primitive0 Nat0
    (unsafeCoerce (S (S (S (S (S (S (S (S (S (S O)))))))))))) TT) (Abs
    (Type_primitive Z1) (Type_primitive Z1) (\x0 -> Var (Type_primitive Z1)
    x0))))))

part3_Fast :: () -> Expr1
part3_Fast _ =
  toFlat (Arrow (Type_primitive Unit) (Type_primitive Z1)) (\_ ->
    partialEvaluate Prelude.False (Arrow (Type_primitive Unit)
      (Type_primitive Z1)) (\_ -> computedPart1))
