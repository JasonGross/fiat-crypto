/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang=Java --cmovznz-by-mul --widen-carry --widen-bytes --internal-static --only-signed Poly1305 5 '2^130 - 5' 32 carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
