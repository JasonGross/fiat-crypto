...
func fiat_p521_subborrowx_u58(out1 *uint64, out2 *uint64, arg1 uint64, arg2 uint64, arg3 uint64) {
  var x1 fiat_p521_int128 = ((fiat_p521_int128(arg2) - fiat_p521_int128(arg1)) - fiat_p521_int128(arg3))
  var x2 int64 = (int64(x1) >> 58)
  var x3 uint64 = (uint64(int64(x1)) & 0x3ffffffffffffff)
  *out1 = x3
...
func fiat_p521_subborrowx_u57(out1 *uint64, out2 *uint64, arg1 uint64, arg2 uint64, arg3 uint64) {
  var x1 fiat_p521_int128 = ((fiat_p521_int128(arg2) - fiat_p521_int128(arg1)) - fiat_p521_int128(arg3))
  var x2 int64 = (int64(x1) >> 57)
  var x3 uint64 = (uint64(int64(x1)) & 0x1ffffffffffffff)
  *out1 = x3
  *out2 = (uint64(0x0) - uint64(x2))
}
