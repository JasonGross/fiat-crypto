...
func fiat_25519_subborrowx_u51(out1 *uint64, out2 *uint64, arg1 uint64, arg2 uint64, arg3 uint64) {
  var x1 fiat_25519_int128 = ((fiat_25519_int128(arg2) - fiat_25519_int128(arg1)) - fiat_25519_int128(arg3))
  var x2 int64 = (int64(x1) >> 51)
  var x3 uint64 = (uint64(int64(x1)) & 0x7ffffffffffff)
  *out1 = x3
