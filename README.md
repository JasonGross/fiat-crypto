...
The license text applying to this software can be found in [`LICENSE`](./LICENSE).

The files generated by the pipeline are not subject to this restriction and instead include their own, slightly more permissive, license text at the top of the file.
