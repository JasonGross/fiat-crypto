/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --static p448 8 '2^448 - 2^224 - 1' 64 carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes */
 ...
 *
 * Input Bounds:
 *   arg1: [[0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999995], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997]]
 *   arg2: [[0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999995], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997]]
 * Output Bounds:
...
static void fiat_p448_carry_square(uint64_t out1[8], const uint64_t arg1[8]) {
  ...
  uint64_t x3 = (x1 * 0x2);
  uint64_t x4 = (x2 * 0x2);
  uint64_t x5 = ((arg1[7]) * 0x2);
  uint64_t x6 = (arg1[6]);
  uint64_t x7 = (arg1[6]);
  uint64_t x8 = (x6 * 0x2);
  uint64_t x9 = (x7 * 0x2);
  uint64_t x10 = ((arg1[6]) * 0x2);
  uint64_t x11 = (arg1[5]);
  uint64_t x12 = (arg1[5]);
  uint64_t x13 = (x11 * 0x2);
  uint64_t x14 = (x12 * 0x2);
  uint64_t x15 = ((arg1[5]) * 0x2);
  uint64_t x16 = (arg1[4]);
  uint64_t x17 = (arg1[4]);
  uint64_t x18 = ((arg1[4]) * 0x2);
  uint64_t x19 = ((arg1[3]) * 0x2);
  uint64_t x20 = ((arg1[2]) * 0x2);
  uint64_t x21 = ((arg1[1]) * 0x2);
 ...
 * Output Bounds:
 *   out1: [[0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999995], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997], [0x0 ~> 0x319999999999997]]
 */
