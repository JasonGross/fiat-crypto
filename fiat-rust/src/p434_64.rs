...
pub fn fiat_p434_cmovznz_u64(out1: &mut u64, arg1: fiat_p434_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((0x0 as fiat_p434_i2) - (x1 as fiat_p434_i2)) as u64) & 0xffffffffffffffff);
...
pub fn fiat_p434_to_bytes(out1: &mut [u8; 56], arg1: &[u64; 7]) -> () {
  ...
  let x7: u64 = (arg1[0]);
  let x8: u64 = (x7 >> 8);
  let x9: u8 = ((x7 as u8) & 0xff);
  let x10: u64 = (x8 >> 8);
  let x11: u8 = ((x8 as u8) & 0xff);
  let x12: u64 = (x10 >> 8);
  let x13: u8 = ((x10 as u8) & 0xff);
  let x14: u64 = (x12 >> 8);
  let x15: u8 = ((x12 as u8) & 0xff);
  let x16: u64 = (x14 >> 8);
  let x17: u8 = ((x14 as u8) & 0xff);
  let x18: u64 = (x16 >> 8);
  let x19: u8 = ((x16 as u8) & 0xff);
  let x20: u8 = ((x18 >> 8) as u8);
  let x21: u8 = ((x18 as u8) & 0xff);
  let x22: u8 = (x20 & 0xff);
  let x23: u64 = (x6 >> 8);
  let x24: u8 = ((x6 as u8) & 0xff);
  let x25: u64 = (x23 >> 8);
  let x26: u8 = ((x23 as u8) & 0xff);
  let x27: u64 = (x25 >> 8);
  let x28: u8 = ((x25 as u8) & 0xff);
  let x29: u64 = (x27 >> 8);
  let x30: u8 = ((x27 as u8) & 0xff);
  let x31: u64 = (x29 >> 8);
  let x32: u8 = ((x29 as u8) & 0xff);
  let x33: u64 = (x31 >> 8);
  let x34: u8 = ((x31 as u8) & 0xff);
  let x35: u8 = ((x33 >> 8) as u8);
  let x36: u8 = ((x33 as u8) & 0xff);
  let x37: u8 = (x35 & 0xff);
  let x38: u64 = (x5 >> 8);
  let x39: u8 = ((x5 as u8) & 0xff);
  let x40: u64 = (x38 >> 8);
  ...
  let x67: u8 = (x65 & 0xff);
  let x68: u64 = (x3 >> 8);
  let x69: u8 = ((x3 as u8) & 0xff);
  let x70: u64 = (x68 >> 8);
  let x71: u8 = ((x68 as u8) & 0xff);
  let x72: u64 = (x70 >> 8);
  let x73: u8 = ((x70 as u8) & 0xff);
  let x74: u64 = (x72 >> 8);
  let x75: u8 = ((x72 as u8) & 0xff);
  let x76: u64 = (x74 >> 8);
  ...
  let x82: u8 = (x80 & 0xff);
  let x83: u64 = (x2 >> 8);
  let x84: u8 = ((x2 as u8) & 0xff);
  let x85: u64 = (x83 >> 8);
  let x86: u8 = ((x83 as u8) & 0xff);
  let x87: u64 = (x85 >> 8);
  ...
  let x97: u8 = (x95 & 0xff);
  let x98: u64 = (x1 >> 8);
  let x99: u8 = ((x1 as u8) & 0xff);
  let x100: u64 = (x98 >> 8);
  let x101: u8 = ((x98 as u8) & 0xff);
  let x102: u64 = (x100 >> 8);
  let x103: u8 = ((x100 as u8) & 0xff);
  let x104: u64 = (x102 >> 8);
  let x105: u8 = ((x102 as u8) & 0xff);
  let x106: u64 = (x104 >> 8);
