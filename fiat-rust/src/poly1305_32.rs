//! Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang=Rust poly1305 5 '2^130 - 5' 32 carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes
...
pub fn fiat_poly1305_to_bytes(out1: &mut [u8; 17], arg1: &[u32; 5]) -> () {
  ...
  let x52: u8 = (x50 & 0xff);
  let x53: u32 = (x20 >> 8);
  let x54: u8 = ((x20 & (0xff as u32)) as u8);
  let x55: u32 = (x53 >> 8);
...
pub fn fiat_poly1305_from_bytes(out1: &mut [u32; 5], arg1: &[u8; 17]) -> () {
  ...
  let x17: u8 = (arg1[0]);
  let x18: u32 = ((x17 as u32) + (x16 + (x15 + x14)));
  let x19: u8 = ((x18 >> 26) as u8);
  let x20: u32 = (x18 & 0x3ffffff);
  let x21: u32 = ((x4 as u32) + (x3 + (x2 + x1)));
  let x22: u32 = (x7 + (x6 + x5));
  let x23: u32 = (x10 + (x9 + x8));
  let x24: u32 = (x13 + (x12 + x11));
  let x25: u32 = ((x19 as u32) + x24);
  let x26: u8 = ((x25 >> 26) as u8);
  let x27: u32 = (x25 & 0x3ffffff);
  let x28: u32 = ((x26 as u32) + x23);
  let x29: u8 = ((x28 >> 26) as u8);
  let x30: u32 = (x28 & 0x3ffffff);
  let x31: u32 = ((x29 as u32) + x22);
  let x32: u32 = (x31 & 0x3ffffff);
  out1[0] = x20;
  out1[1] = x27;
  out1[2] = x30;
  out1[3] = x32;
