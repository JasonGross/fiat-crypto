//! Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang=Rust p521 9 '2^521 - 1' 64 carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes
