...
pub fn fiat_p521_subborrowx_u58(out1: &mut u64, out2: &mut fiat_p521_u1, arg1: fiat_p521_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: fiat_p521_i1 = (((x1 as i64) >> 58) as fiat_p521_i1);
  let x3: u64 = (((x1 as i64) as u64) & 0x3ffffffffffffff);
  *out1 = x3;
  *out2 = (0x0 - (x2 as fiat_p521_u1));
}
...
pub fn fiat_p521_subborrowx_u57(out1: &mut u64, out2: &mut fiat_p521_u1, arg1: fiat_p521_u1, arg2: u64, arg3: u64) -> () {
  let x1: i128 = (((arg2 as i128) - (arg1 as i128)) - (arg3 as i128));
  let x2: fiat_p521_i1 = (((x1 as i64) >> 57) as fiat_p521_i1);
  let x3: u64 = (((x1 as i64) as u64) & 0x1ffffffffffffff);
  *out1 = x3;
  *out2 = (0x0 - (x2 as fiat_p521_u1));
}
...
pub fn fiat_p521_cmovznz_u64(out1: &mut u64, arg1: fiat_p521_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((0x0 as fiat_p521_i2) - (x1 as fiat_p521_i2)) as u64) & 0xffffffffffffffff);
...
pub fn fiat_p521_carry_mul(out1: &mut [u64; 9], arg1: &[u64; 9], arg2: &[u64; 9]) -> () {
  ...
  let x83: u128 = (x82 >> 58);
  let x84: u64 = ((x82 as u64) & 0x3ffffffffffffff);
  ...
  let x94: u128 = (x93 >> 58);
  let x95: u64 = ((x93 as u64) & 0x3ffffffffffffff);
  let x96: u128 = (x94 + x91);
  let x97: u128 = (x96 >> 58);
  let x98: u64 = ((x96 as u64) & 0x3ffffffffffffff);
  let x99: u128 = (x97 + x90);
  let x100: u128 = (x99 >> 58);
  let x101: u64 = ((x99 as u64) & 0x3ffffffffffffff);
  let x102: u128 = (x100 + x89);
  let x103: u128 = (x102 >> 58);
  let x104: u64 = ((x102 as u64) & 0x3ffffffffffffff);
  ...
  let x110: u64 = ((x108 as u64) & 0x3ffffffffffffff);
  let x111: u128 = (x109 + x86);
  let x112: u128 = (x111 >> 58);
  let x113: u64 = ((x111 as u64) & 0x3ffffffffffffff);
  let x114: u128 = (x112 + x85);
  let x115: u128 = (x114 >> 57);
  let x116: u64 = ((x114 as u64) & 0x1ffffffffffffff);
  let x117: u128 = ((x84 as u128) + x115);
  let x118: u64 = ((x117 >> 58) as u64);
  let x119: u64 = ((x117 as u64) & 0x3ffffffffffffff);
...
pub fn fiat_p521_carry_square(out1: &mut [u64; 9], arg1: &[u64; 9]) -> () {
  ...
  let x63: u128 = (x62 >> 58);
  let x64: u64 = ((x62 as u64) & 0x3ffffffffffffff);
  ...
  let x74: u128 = (x73 >> 58);
  let x75: u64 = ((x73 as u64) & 0x3ffffffffffffff);
  let x76: u128 = (x74 + x71);
  let x77: u128 = (x76 >> 58);
  let x78: u64 = ((x76 as u64) & 0x3ffffffffffffff);
  let x79: u128 = (x77 + x70);
  let x80: u128 = (x79 >> 58);
  let x81: u64 = ((x79 as u64) & 0x3ffffffffffffff);
  let x82: u128 = (x80 + x69);
  let x83: u128 = (x82 >> 58);
  let x84: u64 = ((x82 as u64) & 0x3ffffffffffffff);
  let x85: u128 = (x83 + x68);
  let x86: u128 = (x85 >> 58);
  let x87: u64 = ((x85 as u64) & 0x3ffffffffffffff);
  let x88: u128 = (x86 + x67);
  let x89: u128 = (x88 >> 58);
  let x90: u64 = ((x88 as u64) & 0x3ffffffffffffff);
  let x91: u128 = (x89 + x66);
  let x92: u128 = (x91 >> 58);
  let x93: u64 = ((x91 as u64) & 0x3ffffffffffffff);
  let x94: u128 = (x92 + x65);
  let x95: u128 = (x94 >> 57);
  let x96: u64 = ((x94 as u64) & 0x1ffffffffffffff);
  let x97: u128 = ((x64 as u128) + x95);
  let x98: u64 = ((x97 >> 58) as u64);
  let x99: u64 = ((x97 as u64) & 0x3ffffffffffffff);
...
pub fn fiat_p521_to_bytes(out1: &mut [u8; 66], arg1: &[u64; 9]) -> () {
  ...
  let x43: u64 = (x22 << 2);
  let x44: u64 = (x20 >> 8);
  let x45: u8 = ((x20 as u8) & 0xff);
  let x46: u64 = (x44 >> 8);
  let x47: u8 = ((x44 as u8) & 0xff);
  let x48: u64 = (x46 >> 8);
  let x49: u8 = ((x46 as u8) & 0xff);
  let x50: u64 = (x48 >> 8);
  let x51: u8 = ((x48 as u8) & 0xff);
  let x52: u64 = (x50 >> 8);
  let x53: u8 = ((x50 as u8) & 0xff);
  let x54: u64 = (x52 >> 8);
  ...
  let x59: u64 = (x58 >> 8);
  let x60: u8 = ((x58 as u8) & 0xff);
  let x61: u64 = (x59 >> 8);
  let x62: u8 = ((x59 as u8) & 0xff);
  let x63: u64 = (x61 >> 8);
  let x64: u8 = ((x61 as u8) & 0xff);
  let x65: u64 = (x63 >> 8);
  let x66: u8 = ((x63 as u8) & 0xff);
  let x67: u64 = (x65 >> 8);
  let x68: u8 = ((x65 as u8) & 0xff);
  let x69: u64 = (x67 >> 8);
  ...
  let x74: u64 = (x73 >> 8);
  let x75: u8 = ((x73 as u8) & 0xff);
  let x76: u64 = (x74 >> 8);
  let x77: u8 = ((x74 as u8) & 0xff);
  let x78: u64 = (x76 >> 8);
  let x79: u8 = ((x76 as u8) & 0xff);
  let x80: u64 = (x78 >> 8);
  let x81: u8 = ((x78 as u8) & 0xff);
  let x82: u64 = (x80 >> 8);
  let x83: u8 = ((x80 as u8) & 0xff);
  let x84: u64 = (x82 >> 8);
  ...
  let x89: u64 = (x88 >> 8);
  let x90: u8 = ((x88 as u8) & 0xff);
  let x91: u64 = (x89 >> 8);
  let x92: u8 = ((x89 as u8) & 0xff);
  let x93: u64 = (x91 >> 8);
  let x94: u8 = ((x91 as u8) & 0xff);
  let x95: u64 = (x93 >> 8);
  let x96: u8 = ((x93 as u8) & 0xff);
  let x97: u64 = (x95 >> 8);
  let x98: u8 = ((x95 as u8) & 0xff);
  let x99: u64 = (x97 >> 8);
  let x100: u8 = ((x97 as u8) & 0xff);
  let x101: u8 = ((x99 >> 8) as u8);
  let x102: u8 = ((x99 as u8) & 0xff);
  let x103: u8 = (x101 & 0xff);
  let x104: u64 = (x28 >> 8);
  let x105: u8 = ((x28 as u8) & 0xff);
  let x106: u64 = (x104 >> 8);
  let x107: u8 = ((x104 as u8) & 0xff);
  let x108: u64 = (x106 >> 8);
  let x109: u8 = ((x106 as u8) & 0xff);
  let x110: u64 = (x108 >> 8);
  let x111: u8 = ((x108 as u8) & 0xff);
  let x112: u64 = (x110 >> 8);
  let x113: u8 = ((x110 as u8) & 0xff);
  let x114: u64 = (x112 >> 8);
  let x115: u8 = ((x112 as u8) & 0xff);
  let x116: u8 = ((x114 >> 8) as u8);
  let x117: u8 = ((x114 as u8) & 0xff);
  let x118: u64 = ((x116 as u64) + x40);
  let x119: u64 = (x118 >> 8);
  let x120: u8 = ((x118 as u8) & 0xff);
  let x121: u64 = (x119 >> 8);
  let x122: u8 = ((x119 as u8) & 0xff);
  let x123: u64 = (x121 >> 8);
  let x124: u8 = ((x121 as u8) & 0xff);
  let x125: u64 = (x123 >> 8);
  let x126: u8 = ((x123 as u8) & 0xff);
  let x127: u64 = (x125 >> 8);
  let x128: u8 = ((x125 as u8) & 0xff);
  let x129: u64 = (x127 >> 8);
  let x130: u8 = ((x127 as u8) & 0xff);
  let x131: u8 = ((x129 >> 8) as u8);
  let x132: u8 = ((x129 as u8) & 0xff);
  let x133: u64 = ((x131 as u64) + x39);
  let x134: u64 = (x133 >> 8);
  let x135: u8 = ((x133 as u8) & 0xff);
  let x136: u64 = (x134 >> 8);
  let x137: u8 = ((x134 as u8) & 0xff);
  let x138: u64 = (x136 >> 8);
  let x139: u8 = ((x136 as u8) & 0xff);
  let x140: u64 = (x138 >> 8);
  let x141: u8 = ((x138 as u8) & 0xff);
  let x142: u64 = (x140 >> 8);
  let x143: u8 = ((x140 as u8) & 0xff);
  let x144: u64 = (x142 >> 8);
  let x145: u8 = ((x142 as u8) & 0xff);
  let x146: u8 = ((x144 >> 8) as u8);
  let x147: u8 = ((x144 as u8) & 0xff);
  let x148: u64 = ((x146 as u64) + x38);
  let x149: u64 = (x148 >> 8);
  let x150: u8 = ((x148 as u8) & 0xff);
  let x151: u64 = (x149 >> 8);
  let x152: u8 = ((x149 as u8) & 0xff);
  let x153: u64 = (x151 >> 8);
  let x154: u8 = ((x151 as u8) & 0xff);
  let x155: u64 = (x153 >> 8);
  let x156: u8 = ((x153 as u8) & 0xff);
  let x157: u64 = (x155 >> 8);
  let x158: u8 = ((x155 as u8) & 0xff);
  let x159: u64 = (x157 >> 8);
  let x160: u8 = ((x157 as u8) & 0xff);
  let x161: u8 = ((x159 >> 8) as u8);
  let x162: u8 = ((x159 as u8) & 0xff);
  let x163: u8 = (x161 & 0xff);
  let x164: u64 = (x36 >> 8);
  let x165: u8 = ((x36 as u8) & 0xff);
  let x166: u64 = (x164 >> 8);
  let x167: u8 = ((x164 as u8) & 0xff);
  let x168: u64 = (x166 >> 8);
  let x169: u8 = ((x166 as u8) & 0xff);
  let x170: u64 = (x168 >> 8);
  let x171: u8 = ((x168 as u8) & 0xff);
  let x172: u64 = (x170 >> 8);
  let x173: u8 = ((x170 as u8) & 0xff);
  let x174: u64 = (x172 >> 8);
  let x175: u8 = ((x172 as u8) & 0xff);
  let x176: fiat_p521_u1 = ((x174 >> 8) as fiat_p521_u1);
  let x177: u8 = ((x174 as u8) & 0xff);
  out1[0] = x45;
  out1[1] = x47;
  out1[2] = x49;
  out1[3] = x51;
