...
pub fn fiat_p224_cmovznz_u64(out1: &mut u64, arg1: fiat_p224_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((0x0 as fiat_p224_i2) - (x1 as fiat_p224_i2)) as u64) & 0xffffffffffffffff);
...
pub fn fiat_p224_sub(out1: &mut [u64; 4], arg1: &[u64; 4], arg2: &[u64; 4]) -> () {
  ...
  fiat_p224_addcarryx_u64(&mut x10, &mut x11, 0x0, x1, (((x9 as fiat_p224_u1) & 0x1) as u64));
  let mut x12: u64 = 0;
...
pub fn fiat_p224_to_bytes(out1: &mut [u8; 32], arg1: &[u64; 4]) -> () {
  ...
  let x4: u64 = (arg1[0]);
  let x5: u64 = (x4 >> 8);
  let x6: u8 = ((x4 as u8) & 0xff);
  let x7: u64 = (x5 >> 8);
  let x8: u8 = ((x5 as u8) & 0xff);
  let x9: u64 = (x7 >> 8);
  ...
  let x34: u8 = (x32 & 0xff);
  let x35: u64 = (x2 >> 8);
  let x36: u8 = ((x2 as u8) & 0xff);
  let x37: u64 = (x35 >> 8);
  let x38: u8 = ((x35 as u8) & 0xff);
  let x39: u64 = (x37 >> 8);
