//! Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang=Rust poly1305 3 '2^130 - 5' 64 carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes
...
pub fn fiat_poly1305_to_bytes(out1: &mut [u8; 17], arg1: &[u64; 3]) -> () {
  ...
  let x15: u64 = (x10 << 4);
  let x16: u64 = (x8 >> 8);
  let x17: u8 = ((x8 & (0xff as u64)) as u8);
  let x18: u64 = (x16 >> 8);
  ...
  let x26: u64 = ((x24 as u64) + x15);
  let x27: u64 = (x26 >> 8);
  let x28: u8 = ((x26 & (0xff as u64)) as u8);
  let x29: u64 = (x27 >> 8);
  ...
  let x37: u64 = ((x35 as u64) + x14);
  let x38: u64 = (x37 >> 8);
  let x39: u8 = ((x37 & (0xff as u64)) as u8);
  let x40: u64 = (x38 >> 8);
...
pub fn fiat_poly1305_from_bytes(out1: &mut [u64; 3], arg1: &[u8; 17]) -> () {
  ...
  let x17: u8 = (arg1[0]);
  let x18: u64 = ((x17 as u64) + (x16 + (x15 + (x14 + (x13 + x12)))));
  let x19: u8 = ((x18 >> 44) as u8);
  let x20: u64 = (x18 & 0xfffffffffff);
  let x21: u64 = (x6 + (x5 + (x4 + (x3 + (x2 + x1)))));
  let x22: u64 = (x11 + (x10 + (x9 + (x8 + x7))));
  let x23: u64 = ((x19 as u64) + x22);
  let x24: fiat_poly1305_u1 = ((x23 >> 43) as fiat_poly1305_u1);
  let x25: u64 = (x23 & 0x7ffffffffff);
  let x26: u64 = ((x24 as u64) + x21);
  out1[0] = x20;
  out1[1] = x25;
  out1[2] = x26;
}
