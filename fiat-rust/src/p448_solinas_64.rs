//! Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang=Rust p448 8 '2^448 - 2^224 - 1' 64 carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes
