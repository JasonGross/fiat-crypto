...
pub fn fiat_p448_subborrowx_u56(out1: &mut u64, out2: &mut fiat_p448_u1, arg1: fiat_p448_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: fiat_p448_i1 = (((x1 as i64) >> 56) as fiat_p448_i1);
  let x3: u64 = (((x1 as i64) as u64) & 0xffffffffffffff);
  *out1 = x3;
  *out2 = (0x0 - (x2 as fiat_p448_u1));
}
...
pub fn fiat_p448_cmovznz_u64(out1: &mut u64, arg1: fiat_p448_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((0x0 as fiat_p448_i2) - (x1 as fiat_p448_i2)) as u64) & 0xffffffffffffffff);
...
pub fn fiat_p448_carry_mul(out1: &mut [u64; 8], arg1: &[u64; 8], arg2: &[u64; 8]) -> () {
  ...
  let x101: u64 = ((x99 as u64) & 0xffffffffffffff);
...
pub fn fiat_p448_carry_square(out1: &mut [u64; 8], arg1: &[u64; 8]) -> () {
  ...
  let x80: u64 = ((x78 as u64) & 0xffffffffffffff);
...
pub fn fiat_p448_to_bytes(out1: &mut [u8; 56], arg1: &[u64; 8]) -> () {
  ...
  let x34: u64 = (x18 >> 8);
  let x35: u8 = ((x18 as u8) & 0xff);
  let x36: u64 = (x34 >> 8);
  let x37: u8 = ((x34 as u8) & 0xff);
  let x38: u64 = (x36 >> 8);
  let x39: u8 = ((x36 as u8) & 0xff);
  let x40: u64 = (x38 >> 8);
  let x41: u8 = ((x38 as u8) & 0xff);
  let x42: u64 = (x40 >> 8);
  let x43: u8 = ((x40 as u8) & 0xff);
  let x44: u8 = ((x42 >> 8) as u8);
  let x45: u8 = ((x42 as u8) & 0xff);
  let x46: u8 = (x44 & 0xff);
  let x47: u64 = (x20 >> 8);
  let x48: u8 = ((x20 as u8) & 0xff);
  let x49: u64 = (x47 >> 8);
  let x50: u8 = ((x47 as u8) & 0xff);
  let x51: u64 = (x49 >> 8);
  let x52: u8 = ((x49 as u8) & 0xff);
  let x53: u64 = (x51 >> 8);
  let x54: u8 = ((x51 as u8) & 0xff);
  let x55: u64 = (x53 >> 8);
  let x56: u8 = ((x53 as u8) & 0xff);
  let x57: u8 = ((x55 >> 8) as u8);
  let x58: u8 = ((x55 as u8) & 0xff);
  let x59: u8 = (x57 & 0xff);
  let x60: u64 = (x22 >> 8);
  let x61: u8 = ((x22 as u8) & 0xff);
  let x62: u64 = (x60 >> 8);
  ...
  let x71: u8 = ((x68 as u8) & 0xff);
  let x72: u8 = (x70 & 0xff);
  let x73: u64 = (x24 >> 8);
  let x74: u8 = ((x24 as u8) & 0xff);
  let x75: u64 = (x73 >> 8);
  ...
  let x81: u64 = (x79 >> 8);
  let x82: u8 = ((x79 as u8) & 0xff);
  let x83: u8 = ((x81 >> 8) as u8);
  let x84: u8 = ((x81 as u8) & 0xff);
  let x85: u8 = (x83 & 0xff);
  let x86: u64 = (x26 >> 8);
  let x87: u8 = ((x26 as u8) & 0xff);
  let x88: u64 = (x86 >> 8);
  ...
  let x98: u8 = (x96 & 0xff);
  let x99: u64 = (x28 >> 8);
  let x100: u8 = ((x28 as u8) & 0xff);
  let x101: u64 = (x99 >> 8);
  let x102: u8 = ((x99 as u8) & 0xff);
  let x103: u64 = (x101 >> 8);
  let x104: u8 = ((x101 as u8) & 0xff);
  let x105: u64 = (x103 >> 8);
  let x106: u8 = ((x103 as u8) & 0xff);
  let x107: u64 = (x105 >> 8);
  let x108: u8 = ((x105 as u8) & 0xff);
  let x109: u8 = ((x107 >> 8) as u8);
  let x110: u8 = ((x107 as u8) & 0xff);
  let x111: u8 = (x109 & 0xff);
  let x112: u64 = (x30 >> 8);
  let x113: u8 = ((x30 as u8) & 0xff);
  let x114: u64 = (x112 >> 8);
  let x115: u8 = ((x112 as u8) & 0xff);
  let x116: u64 = (x114 >> 8);
  let x117: u8 = ((x114 as u8) & 0xff);
  let x118: u64 = (x116 >> 8);
  let x119: u8 = ((x116 as u8) & 0xff);
  let x120: u64 = (x118 >> 8);
  let x121: u8 = ((x118 as u8) & 0xff);
  let x122: u8 = ((x120 >> 8) as u8);
  let x123: u8 = ((x120 as u8) & 0xff);
  let x124: u8 = (x122 & 0xff);
  let x125: u64 = (x32 >> 8);
  let x126: u8 = ((x32 as u8) & 0xff);
  let x127: u64 = (x125 >> 8);
  ...
  let x133: u64 = (x131 >> 8);
  let x134: u8 = ((x131 as u8) & 0xff);
  let x135: u8 = ((x133 >> 8) as u8);
  let x136: u8 = ((x133 as u8) & 0xff);
  out1[0] = x35;
  out1[1] = x37;
  out1[2] = x39;
  out1[3] = x41;
