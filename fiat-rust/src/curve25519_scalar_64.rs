...
pub fn fiat_25519_scalar_sub(out1: &mut fiat_25519_scalar_montgomery_domain_field_element, arg1: &fiat_25519_scalar_montgomery_domain_field_element, arg2: &fiat_25519_scalar_montgomery_domain_field_element) {
  ...
  let mut x9: u64 = 0;
  let mut x10: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x9, &mut x10, x8, (0x0 as u64), (0x0 as u64));
  let mut x11: u64 = 0;
  let mut x12: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x11, &mut x12, 0x0, x1, (x9 & 0x5812631a5cf5d3ed));
  let mut x13: u64 = 0;
  let mut x14: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x13, &mut x14, x12, x3, (x9 & 0x14def9dea2f79cd6));
  let mut x15: u64 = 0;
  let mut x16: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x15, &mut x16, x14, x5, (0x0 as u64));
  let mut x17: u64 = 0;
  let mut x18: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x17, &mut x18, x16, x7, (x9 & 0x1000000000000000));
  out1[0] = x11;
  out1[1] = x13;
  out1[2] = x15;
  out1[3] = x17;
...
pub fn fiat_25519_scalar_divstep(out1: &mut u64, out2: &mut [u64; 5], out3: &mut [u64; 5], out4: &mut [u64; 4], out5: &mut [u64; 4], arg1: u64, arg2: &[u64; 5], arg3: &[u64; 5], arg4: &[u64; 4], arg5: &[u64; 4]) {
  ...
  fiat_25519_scalar_subborrowx_u64(&mut x61, &mut x62, x60, (0x0 as u64), (0x0 as u64));
  let mut x63: u64 = 0;
  let mut x64: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x63, &mut x64, 0x0, x53, (x61 & 0x5812631a5cf5d3ed));
  let mut x65: u64 = 0;
  let mut x66: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x65, &mut x66, x64, x55, (x61 & 0x14def9dea2f79cd6));
  let mut x67: u64 = 0;
  let mut x68: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x67, &mut x68, x66, x57, (0x0 as u64));
  let mut x69: u64 = 0;
  let mut x70: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x69, &mut x70, x68, x59, (x61 & 0x1000000000000000));
  let mut x71: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x71, x3, (arg5[0]), x63);
  let mut x72: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x72, x3, (arg5[1]), x65);
  let mut x73: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x73, x3, (arg5[2]), x67);
  let mut x74: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x74, x3, (arg5[3]), x69);
  let x75: fiat_25519_scalar_u1 = ((x22 & (0x1 as u64)) as fiat_25519_scalar_u1);
  let mut x76: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x76, x75, (0x0 as u64), x7);
  let mut x77: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x77, x75, (0x0 as u64), x8);
  let mut x78: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x78, x75, (0x0 as u64), x9);
  let mut x79: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x79, x75, (0x0 as u64), x10);
  let mut x80: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x80, x75, (0x0 as u64), x11);
  let mut x81: u64 = 0;
  let mut x82: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x81, &mut x82, 0x0, x22, x76);
  let mut x83: u64 = 0;
  let mut x84: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x83, &mut x84, x82, x23, x77);
  let mut x85: u64 = 0;
  let mut x86: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x85, &mut x86, x84, x24, x78);
  let mut x87: u64 = 0;
  let mut x88: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x87, &mut x88, x86, x25, x79);
  let mut x89: u64 = 0;
  let mut x90: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x89, &mut x90, x88, x26, x80);
  let mut x91: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x91, x75, (0x0 as u64), x27);
  let mut x92: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x92, x75, (0x0 as u64), x28);
  let mut x93: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x93, x75, (0x0 as u64), x29);
  let mut x94: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x94, x75, (0x0 as u64), x30);
  let mut x95: u64 = 0;
  let mut x96: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x95, &mut x96, 0x0, x71, x91);
  let mut x97: u64 = 0;
  let mut x98: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x97, &mut x98, x96, x72, x92);
  let mut x99: u64 = 0;
  let mut x100: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x99, &mut x100, x98, x73, x93);
  let mut x101: u64 = 0;
  let mut x102: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x101, &mut x102, x100, x74, x94);
  let mut x103: u64 = 0;
  let mut x104: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x103, &mut x104, 0x0, x95, 0x5812631a5cf5d3ed);
  let mut x105: u64 = 0;
  let mut x106: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x105, &mut x106, x104, x97, 0x14def9dea2f79cd6);
  let mut x107: u64 = 0;
  let mut x108: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x107, &mut x108, x106, x99, (0x0 as u64));
  let mut x109: u64 = 0;
  let mut x110: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x109, &mut x110, x108, x101, 0x1000000000000000);
  let mut x111: u64 = 0;
  let mut x112: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_subborrowx_u64(&mut x111, &mut x112, x110, (x102 as u64), (0x0 as u64));
  let mut x113: u64 = 0;
  let mut x114: fiat_25519_scalar_u1 = 0;
  fiat_25519_scalar_addcarryx_u64(&mut x113, &mut x114, 0x0, x6, (0x1 as u64));
  ...
  let mut x120: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x120, x48, x39, x31);
  let mut x121: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x121, x48, x41, x33);
  let mut x122: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x122, x48, x43, x35);
  let mut x123: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x123, x48, x45, x37);
  let mut x124: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x124, x112, x103, x95);
  let mut x125: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x125, x112, x105, x97);
  let mut x126: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x126, x112, x107, x99);
  let mut x127: u64 = 0;
  fiat_25519_scalar_cmovznz_u64(&mut x127, x112, x109, x101);
  *out1 = x113;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
