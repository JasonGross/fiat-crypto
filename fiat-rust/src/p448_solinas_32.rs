...
pub fn fiat_p448_to_bytes(out1: &mut [u8; 56], arg1: &fiat_p448_tight_field_element) {
  ...
  let mut x33: u32 = 0;
  let mut x34: fiat_p448_u1 = 0;
  fiat_p448_subborrowx_u32(&mut x33, &mut x34, x32, (0x0 as u32), (0x0 as u32));
  let mut x35: u32 = 0;
  let mut x36: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x35, &mut x36, 0x0, x1, (x33 & 0xfffffff));
  let mut x37: u32 = 0;
  let mut x38: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x37, &mut x38, x36, x3, (x33 & 0xfffffff));
  let mut x39: u32 = 0;
  let mut x40: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x39, &mut x40, x38, x5, (x33 & 0xfffffff));
  let mut x41: u32 = 0;
  let mut x42: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x41, &mut x42, x40, x7, (x33 & 0xfffffff));
  let mut x43: u32 = 0;
  let mut x44: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x43, &mut x44, x42, x9, (x33 & 0xfffffff));
  let mut x45: u32 = 0;
  let mut x46: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x45, &mut x46, x44, x11, (x33 & 0xfffffff));
  let mut x47: u32 = 0;
  let mut x48: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x47, &mut x48, x46, x13, (x33 & 0xfffffff));
  let mut x49: u32 = 0;
  let mut x50: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x49, &mut x50, x48, x15, (x33 & 0xfffffff));
  let mut x51: u32 = 0;
  let mut x52: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x51, &mut x52, x50, x17, (x33 & 0xffffffe));
  let mut x53: u32 = 0;
  let mut x54: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x53, &mut x54, x52, x19, (x33 & 0xfffffff));
  let mut x55: u32 = 0;
  let mut x56: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x55, &mut x56, x54, x21, (x33 & 0xfffffff));
  let mut x57: u32 = 0;
  let mut x58: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x57, &mut x58, x56, x23, (x33 & 0xfffffff));
  let mut x59: u32 = 0;
  let mut x60: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x59, &mut x60, x58, x25, (x33 & 0xfffffff));
  let mut x61: u32 = 0;
  let mut x62: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x61, &mut x62, x60, x27, (x33 & 0xfffffff));
  let mut x63: u32 = 0;
  let mut x64: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x63, &mut x64, x62, x29, (x33 & 0xfffffff));
  let mut x65: u32 = 0;
  let mut x66: fiat_p448_u1 = 0;
  fiat_p448_addcarryx_u28(&mut x65, &mut x66, x64, x31, (x33 & 0xfffffff));
  let x67: u32 = (x65 << 4);
  let x68: u32 = (x61 << 4);
  let x69: u32 = (x57 << 4);
  let x70: u32 = (x53 << 4);
  ...
  let x114: u8 = ((x47 & (0xff as u32)) as u8);
  let x115: u32 = (x47 >> 8);
  let x116: u8 = ((x115 & (0xff as u32)) as u8);
  let x117: u32 = (x115 >> 8);
  let x118: u8 = ((x117 & (0xff as u32)) as u8);
  let x119: u8 = ((x117 >> 8) as u8);
  let x120: u32 = (x71 + (x119 as u32));
  let x121: u8 = ((x120 & (0xff as u32)) as u8);
  let x122: u32 = (x120 >> 8);
  let x123: u8 = ((x122 & (0xff as u32)) as u8);
  let x124: u32 = (x122 >> 8);
  let x125: u8 = ((x124 & (0xff as u32)) as u8);
  let x126: u8 = ((x124 >> 8) as u8);
  let x127: u8 = ((x51 & (0xff as u32)) as u8);
  let x128: u32 = (x51 >> 8);
  let x129: u8 = ((x128 & (0xff as u32)) as u8);
  let x130: u32 = (x128 >> 8);
  let x131: u8 = ((x130 & (0xff as u32)) as u8);
  let x132: u8 = ((x130 >> 8) as u8);
  let x133: u32 = (x70 + (x132 as u32));
