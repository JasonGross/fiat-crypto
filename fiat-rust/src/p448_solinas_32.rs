//! Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang=Rust p448 16 '2^448 - 2^224 - 1' 32 carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes
...
pub fn fiat_p448_carry_mul(out1: &mut [u32; 16], arg1: &[u32; 16], arg2: &[u32; 16]) -> () {
  ...
  let x410: u128 = ((x391 as u128) + ((x376 as u128) + ((x362 + (x349 + (x337 + (x326 + (x316 + (x307 + (x299 + (x292 + (x286 + (x281 + (x277 + (x274 + (x248 + (x242 + (x235 + (x227 + (x219 + (x211 + (x203 + (x195 + (x187 + (x179 + (x72 + (x58 + (x36 + x30))))))))))))))))))))))))) as u128)));
  let x411: u128 = ((x392 as u128) + ((x377 as u128) + ((x363 as u128) + ((x350 as u128) + ((x338 + (x327 + (x317 + (x308 + (x300 + (x293 + (x287 + (x282 + (x278 + (x254 + (x249 + (x243 + (x236 + (x228 + (x220 + (x212 + (x204 + (x196 + (x188 + (x180 + (x86 + (x73 + (x59 + (x42 + (x37 + x31))))))))))))))))))))))))) as u128)))));
  let x412: u128 = ((x393 as u128) + ((x378 as u128) + ((x364 as u128) + ((x351 as u128) + ((x339 as u128) + ((x328 as u128) + ((x318 + (x309 + (x301 + (x294 + (x288 + (x283 + (x259 + (x255 + (x250 + (x244 + (x237 + (x229 + (x221 + (x213 + (x205 + (x197 + (x189 + (x181 + (x99 + (x87 + (x74 + (x60 + (x47 + (x43 + (x38 + x32))))))))))))))))))))))))) as u128)))))));
  let x413: u128 = ((x394 as u128) + ((x379 as u128) + ((x365 as u128) + ((x352 as u128) + ((x340 as u128) + ((x329 as u128) + ((x319 as u128) + ((x310 as u128) + ((x302 + (x295 + (x289 + (x263 + (x260 + (x256 + (x251 + (x245 + (x238 + (x230 + (x222 + (x214 + (x206 + (x198 + (x190 + (x182 + (x111 + (x100 + (x88 + (x75 + (x61 + (x51 + (x48 + (x44 + (x39 + x33))))))))))))))))))))))))) as u128)))))))));
  let x414: u128 = ((x395 as u128) + ((x380 as u128) + ((x366 as u128) + ((x353 as u128) + ((x341 as u128) + ((x330 as u128) + ((x320 as u128) + ((x311 as u128) + ((x303 as u128) + ((x296 as u128) + ((x266 + (x264 + (x261 + (x257 + (x252 + (x246 + (x239 + (x231 + (x223 + (x215 + (x207 + (x199 + (x191 + (x183 + (x122 + (x112 + (x101 + (x89 + (x76 + (x62 + (x54 + (x52 + (x49 + (x45 + (x40 + x34))))))))))))))))))))))))) as u128)))))))))));
  let x415: u128 = ((x396 as u128) + ((x381 as u128) + ((x367 as u128) + ((x354 as u128) + ((x342 as u128) + ((x331 as u128) + ((x321 as u128) + ((x312 as u128) + ((x304 as u128) + ((x268 as u128) + ((x267 as u128) + ((x265 as u128) + ((x262 + (x258 + (x253 + (x247 + (x240 + (x232 + (x224 + (x216 + (x208 + (x200 + (x192 + (x184 + (x132 + (x123 + (x113 + (x102 + (x90 + (x77 + (x63 + (x56 + (x55 + (x53 + (x50 + (x46 + (x41 + x35))))))))))))))))))))))))) as u128)))))))))))));
  ...
  let x454: u128 = ((x452 as u128) + x410);
  let x455: u64 = (x451 >> 28);
  let x456: u32 = ((x451 & (0xfffffff as u64)) as u32);
  let x457: u64 = (x455 + x417);
  let x458: u64 = ((x454 >> 28) as u64);
  let x459: u32 = ((x454 & (0xfffffff as u128)) as u32);
...
pub fn fiat_p448_carry_square(out1: &mut [u32; 16], arg1: &[u32; 16]) -> () {
  ...
  let x267: u128 = ((x248 as u128) + ((x234 + (x220 + (x206 + (x192 + (x178 + (x164 + (x151 + (x137 + (x123 + (x111 + (x102 + (x79 + x63)))))))))))) as u128));
  let x268: u128 = ((x249 as u128) + ((x235 as u128) + ((x221 + (x207 + (x193 + (x179 + (x167 + (x165 + (x153 + (x139 + (x125 + (x113 + (x104 + (x81 + (x80 + (x65 + x64)))))))))))))) as u128)));
  let x269: u128 = ((x250 as u128) + ((x236 as u128) + ((x222 as u128) + ((x208 + (x194 + (x183 + (x180 + (x169 + (x155 + (x141 + (x127 + (x115 + (x84 + (x82 + (x68 + x66)))))))))))) as u128))));
  let x270: u128 = ((x251 as u128) + ((x237 as u128) + ((x223 as u128) + ((x209 as u128) + ((x199 + (x195 + (x185 + (x181 + (x171 + (x157 + (x143 + (x129 + (x117 + (x88 + (x85 + (x83 + (x72 + (x69 + x67)))))))))))))) as u128)))));
  let x271: u128 = ((x252 as u128) + ((x238 as u128) + ((x224 as u128) + ((x215 as u128) + ((x210 as u128) + ((x201 + (x196 + (x187 + (x173 + (x159 + (x145 + (x131 + (x95 + (x89 + (x86 + (x75 + (x73 + x70)))))))))))) as u128))))));
  let x272: u128 = ((x253 as u128) + ((x239 as u128) + ((x231 as u128) + ((x225 as u128) + ((x217 as u128) + ((x211 as u128) + ((x203 + (x197 + (x189 + (x175 + (x161 + (x147 + (x133 + (x105 + (x96 + (x90 + (x87 + (x77 + (x76 + (x74 + x71)))))))))))))) as u128)))))));
  ...
  let x311: u128 = ((x309 as u128) + x267);
  let x312: u64 = (x308 >> 28);
  let x313: u32 = ((x308 & (0xfffffff as u64)) as u32);
  let x314: u64 = (x312 + x274);
  let x315: u64 = ((x311 >> 28) as u64);
  let x316: u32 = ((x311 & (0xfffffff as u128)) as u32);
...
pub fn fiat_p448_to_bytes(out1: &mut [u8; 56], arg1: &[u32; 16]) -> () {
  ...
  let x73: u32 = (x36 << 4);
  let x74: u32 = (x34 >> 8);
  let x75: u8 = ((x34 & (0xff as u32)) as u8);
  let x76: u32 = (x74 >> 8);
  let x77: u8 = ((x74 & (0xff as u32)) as u8);
  let x78: u8 = ((x76 >> 8) as u8);
  let x79: u8 = ((x76 & (0xff as u32)) as u8);
  let x80: u32 = ((x78 as u32) + x73);
  let x81: u32 = (x80 >> 8);
  let x82: u8 = ((x80 & (0xff as u32)) as u8);
  let x83: u32 = (x81 >> 8);
  let x84: u8 = ((x81 & (0xff as u32)) as u8);
  let x85: u8 = ((x83 >> 8) as u8);
  let x86: u8 = ((x83 & (0xff as u32)) as u8);
  let x87: u8 = (x85 & 0xff);
  let x88: u32 = (x38 >> 8);
  let x89: u8 = ((x38 & (0xff as u32)) as u8);
  let x90: u32 = (x88 >> 8);
  let x91: u8 = ((x88 & (0xff as u32)) as u8);
  let x92: u8 = ((x90 >> 8) as u8);
  let x93: u8 = ((x90 & (0xff as u32)) as u8);
  let x94: u32 = ((x92 as u32) + x72);
  let x95: u32 = (x94 >> 8);
  let x96: u8 = ((x94 & (0xff as u32)) as u8);
  let x97: u32 = (x95 >> 8);
  let x98: u8 = ((x95 & (0xff as u32)) as u8);
  let x99: u8 = ((x97 >> 8) as u8);
  let x100: u8 = ((x97 & (0xff as u32)) as u8);
  let x101: u8 = (x99 & 0xff);
  let x102: u32 = (x42 >> 8);
  let x103: u8 = ((x42 & (0xff as u32)) as u8);
  let x104: u32 = (x102 >> 8);
  let x105: u8 = ((x102 & (0xff as u32)) as u8);
  let x106: u8 = ((x104 >> 8) as u8);
  let x107: u8 = ((x104 & (0xff as u32)) as u8);
  let x108: u32 = ((x106 as u32) + x71);
  let x109: u32 = (x108 >> 8);
  let x110: u8 = ((x108 & (0xff as u32)) as u8);
  let x111: u32 = (x109 >> 8);
  let x112: u8 = ((x109 & (0xff as u32)) as u8);
  let x113: u8 = ((x111 >> 8) as u8);
  let x114: u8 = ((x111 & (0xff as u32)) as u8);
  let x115: u8 = (x113 & 0xff);
  let x116: u32 = (x46 >> 8);
  let x117: u8 = ((x46 & (0xff as u32)) as u8);
  let x118: u32 = (x116 >> 8);
  let x119: u8 = ((x116 & (0xff as u32)) as u8);
  let x120: u8 = ((x118 >> 8) as u8);
  let x121: u8 = ((x118 & (0xff as u32)) as u8);
  let x122: u32 = ((x120 as u32) + x70);
  let x123: u32 = (x122 >> 8);
  let x124: u8 = ((x122 & (0xff as u32)) as u8);
  let x125: u32 = (x123 >> 8);
  let x126: u8 = ((x123 & (0xff as u32)) as u8);
  let x127: u8 = ((x125 >> 8) as u8);
  let x128: u8 = ((x125 & (0xff as u32)) as u8);
  let x129: u8 = (x127 & 0xff);
  let x130: u32 = (x50 >> 8);
  let x131: u8 = ((x50 & (0xff as u32)) as u8);
  let x132: u32 = (x130 >> 8);
  let x133: u8 = ((x130 & (0xff as u32)) as u8);
  let x134: u8 = ((x132 >> 8) as u8);
  let x135: u8 = ((x132 & (0xff as u32)) as u8);
  let x136: u32 = ((x134 as u32) + x69);
  let x137: u32 = (x136 >> 8);
  let x138: u8 = ((x136 & (0xff as u32)) as u8);
  let x139: u32 = (x137 >> 8);
  let x140: u8 = ((x137 & (0xff as u32)) as u8);
  let x141: u8 = ((x139 >> 8) as u8);
  let x142: u8 = ((x139 & (0xff as u32)) as u8);
  let x143: u8 = (x141 & 0xff);
  let x144: u32 = (x54 >> 8);
  let x145: u8 = ((x54 & (0xff as u32)) as u8);
  let x146: u32 = (x144 >> 8);
  let x147: u8 = ((x144 & (0xff as u32)) as u8);
  let x148: u8 = ((x146 >> 8) as u8);
  let x149: u8 = ((x146 & (0xff as u32)) as u8);
  let x150: u32 = ((x148 as u32) + x68);
  let x151: u32 = (x150 >> 8);
  let x152: u8 = ((x150 & (0xff as u32)) as u8);
  let x153: u32 = (x151 >> 8);
  let x154: u8 = ((x151 & (0xff as u32)) as u8);
  let x155: u8 = ((x153 >> 8) as u8);
  let x156: u8 = ((x153 & (0xff as u32)) as u8);
  let x157: u8 = (x155 & 0xff);
  let x158: u32 = (x58 >> 8);
  let x159: u8 = ((x58 & (0xff as u32)) as u8);
  let x160: u32 = (x158 >> 8);
  let x161: u8 = ((x158 & (0xff as u32)) as u8);
  let x162: u8 = ((x160 >> 8) as u8);
  let x163: u8 = ((x160 & (0xff as u32)) as u8);
  let x164: u32 = ((x162 as u32) + x67);
  let x165: u32 = (x164 >> 8);
  let x166: u8 = ((x164 & (0xff as u32)) as u8);
  let x167: u32 = (x165 >> 8);
  let x168: u8 = ((x165 & (0xff as u32)) as u8);
  let x169: u8 = ((x167 >> 8) as u8);
  let x170: u8 = ((x167 & (0xff as u32)) as u8);
  let x171: u8 = (x169 & 0xff);
  let x172: u32 = (x62 >> 8);
  let x173: u8 = ((x62 & (0xff as u32)) as u8);
  let x174: u32 = (x172 >> 8);
  let x175: u8 = ((x172 & (0xff as u32)) as u8);
  let x176: u8 = ((x174 >> 8) as u8);
  let x177: u8 = ((x174 & (0xff as u32)) as u8);
  let x178: u32 = ((x176 as u32) + x66);
  let x179: u32 = (x178 >> 8);
  let x180: u8 = ((x178 & (0xff as u32)) as u8);
  let x181: u32 = (x179 >> 8);
  let x182: u8 = ((x179 & (0xff as u32)) as u8);
  let x183: u8 = ((x181 >> 8) as u8);
  let x184: u8 = ((x181 & (0xff as u32)) as u8);
  out1[0] = x75;
  out1[1] = x77;
  out1[2] = x79;
  out1[3] = x82;
...
pub fn fiat_p448_from_bytes(out1: &mut [u32; 16], arg1: &[u8; 56]) -> () {
  ...
  let x56: u8 = (arg1[0]);
  let x57: u32 = ((x56 as u32) + (x55 + (x54 + x53)));
  let x58: u8 = ((x57 >> 28) as u8);
  let x59: u32 = (x57 & 0xfffffff);
  let x60: u32 = (x3 + (x2 + x1));
  let x61: u32 = ((x7 as u32) + (x6 + (x5 + x4)));
  let x62: u32 = (x10 + (x9 + x8));
  let x63: u32 = ((x14 as u32) + (x13 + (x12 + x11)));
  let x64: u32 = (x17 + (x16 + x15));
  let x65: u32 = ((x21 as u32) + (x20 + (x19 + x18)));
  let x66: u32 = (x24 + (x23 + x22));
  let x67: u32 = ((x28 as u32) + (x27 + (x26 + x25)));
  let x68: u32 = (x31 + (x30 + x29));
  let x69: u32 = ((x35 as u32) + (x34 + (x33 + x32)));
  let x70: u32 = (x38 + (x37 + x36));
  let x71: u32 = ((x42 as u32) + (x41 + (x40 + x39)));
  let x72: u32 = (x45 + (x44 + x43));
  let x73: u32 = ((x49 as u32) + (x48 + (x47 + x46)));
  let x74: u32 = (x52 + (x51 + x50));
  let x75: u32 = ((x58 as u32) + x74);
  let x76: u32 = (x75 & 0xfffffff);
  let x77: u8 = ((x73 >> 28) as u8);
  let x78: u32 = (x73 & 0xfffffff);
  let x79: u32 = ((x77 as u32) + x72);
  let x80: u32 = (x79 & 0xfffffff);
  let x81: u8 = ((x71 >> 28) as u8);
  let x82: u32 = (x71 & 0xfffffff);
  let x83: u32 = ((x81 as u32) + x70);
  let x84: u32 = (x83 & 0xfffffff);
  let x85: u8 = ((x69 >> 28) as u8);
  let x86: u32 = (x69 & 0xfffffff);
  let x87: u32 = ((x85 as u32) + x68);
  let x88: u32 = (x87 & 0xfffffff);
  let x89: u8 = ((x67 >> 28) as u8);
  let x90: u32 = (x67 & 0xfffffff);
  let x91: u32 = ((x89 as u32) + x66);
  let x92: u32 = (x91 & 0xfffffff);
  let x93: u8 = ((x65 >> 28) as u8);
  let x94: u32 = (x65 & 0xfffffff);
  let x95: u32 = ((x93 as u32) + x64);
  let x96: u32 = (x95 & 0xfffffff);
  let x97: u8 = ((x63 >> 28) as u8);
  let x98: u32 = (x63 & 0xfffffff);
  let x99: u32 = ((x97 as u32) + x62);
  let x100: u32 = (x99 & 0xfffffff);
  let x101: u8 = ((x61 >> 28) as u8);
  let x102: u32 = (x61 & 0xfffffff);
  let x103: u32 = ((x101 as u32) + x60);
  out1[0] = x59;
  out1[1] = x76;
  out1[2] = x78;
  out1[3] = x80;
