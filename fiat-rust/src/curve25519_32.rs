/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang=Rust 25519 10 '2^255 - 19' 32 carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes carry_scmul121666 */
...
pub fn fiat_25519_subborrowx_u26(out1: &mut u32, out2: &mut fiat_25519_u1, arg1: fiat_25519_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x2: fiat_25519_i1 = (((x1 as i32) >> 26) as fiat_25519_i1);
  let x3: u32 = (((x1 as i32) as u32) & 0x3ffffff);
  *out1 = x3;
...
pub fn fiat_25519_subborrowx_u25(out1: &mut u32, out2: &mut fiat_25519_u1, arg1: fiat_25519_u1, arg2: u32, arg3: u32) -> () {
  let x1: i64 = (((arg2 as i64) - (arg1 as i64)) - (arg3 as i64));
  let x2: fiat_25519_i1 = (((x1 as i32) >> 25) as fiat_25519_i1);
  let x3: u32 = (((x1 as i32) as u32) & 0x1ffffff);
  *out1 = x3;
  *out2 = (0x0 - (x2 as fiat_25519_u1));
}
...
pub fn fiat_25519_cmovznz_u32(out1: &mut u32, arg1: fiat_25519_u1, arg2: u32, arg3: u32) -> () {
  ...
  let x2: u32 = ((((0x0 as fiat_25519_i2) - (x1 as fiat_25519_i2)) as u32) & 0xffffffff);
...
pub fn fiat_25519_carry_mul(out1: &mut [u32; 10], arg1: &[u32; 10], arg2: &[u32; 10]) -> () {
  ...
  let x103: u32 = ((x101 as u32) & 0x3ffffff);
...
pub fn fiat_25519_carry_square(out1: &mut [u32; 10], arg1: &[u32; 10]) -> () {
  ...
  let x75: u64 = (x74 >> 26);
  let x76: u32 = ((x74 as u32) & 0x3ffffff);
  ...
  let x86: u64 = (x75 + x85);
  let x87: u64 = (x86 >> 25);
  let x88: u32 = ((x86 as u32) & 0x1ffffff);
  let x89: u64 = (x87 + x84);
  let x90: u64 = (x89 >> 26);
  let x91: u32 = ((x89 as u32) & 0x3ffffff);
  let x92: u64 = (x90 + x83);
  let x93: u64 = (x92 >> 25);
  let x94: u32 = ((x92 as u32) & 0x1ffffff);
  let x95: u64 = (x93 + x82);
  let x96: u64 = (x95 >> 26);
  let x97: u32 = ((x95 as u32) & 0x3ffffff);
  let x98: u64 = (x96 + x81);
  let x99: u64 = (x98 >> 25);
  let x100: u32 = ((x98 as u32) & 0x1ffffff);
  let x101: u64 = (x99 + x80);
  let x102: u64 = (x101 >> 26);
  let x103: u32 = ((x101 as u32) & 0x3ffffff);
  let x104: u64 = (x102 + x79);
  let x105: u64 = (x104 >> 25);
  let x106: u32 = ((x104 as u32) & 0x1ffffff);
  let x107: u64 = (x105 + x78);
  let x108: u64 = (x107 >> 26);
  let x109: u32 = ((x107 as u32) & 0x3ffffff);
  let x110: u64 = (x108 + x77);
  let x111: u64 = (x110 >> 25);
  let x112: u32 = ((x110 as u32) & 0x1ffffff);
  let x113: u64 = (x111 * (0x13 as u64));
  let x114: u64 = ((x76 as u64) + x113);
  let x115: u32 = ((x114 >> 26) as u32);
  let x116: u32 = ((x114 as u32) & 0x3ffffff);
...
pub fn fiat_25519_to_bytes(out1: &mut [u8; 32], arg1: &[u32; 10]) -> () {
  ...
  let x57: u32 = (x56 >> 8);
  let x58: u8 = ((x56 as u8) & 0xff);
  let x59: u32 = (x57 >> 8);
  let x60: u8 = ((x57 as u8) & 0xff);
  let x61: u8 = ((x59 >> 8) as u8);
  let x62: u8 = ((x59 as u8) & 0xff);
  let x63: u32 = ((x61 as u32) + x48);
  let x64: u32 = (x63 >> 8);
  let x65: u8 = ((x63 as u8) & 0xff);
  let x66: u32 = (x64 >> 8);
  let x67: u8 = ((x64 as u8) & 0xff);
  let x68: u8 = ((x66 >> 8) as u8);
  let x69: u8 = ((x66 as u8) & 0xff);
  let x70: u32 = ((x68 as u32) + x47);
  let x71: u32 = (x70 >> 8);
  let x72: u8 = ((x70 as u8) & 0xff);
  let x73: u32 = (x71 >> 8);
  ...
  let x113: u32 = (x112 >> 8);
  let x114: u8 = ((x112 as u8) & 0xff);
  let x115: u32 = (x113 >> 8);
  let x116: u8 = ((x113 as u8) & 0xff);
  let x117: u8 = ((x115 >> 8) as u8);
  let x118: u8 = ((x115 as u8) & 0xff);
  out1[0] = x51;
  out1[1] = x53;
  out1[2] = x55;
  out1[3] = x58;
