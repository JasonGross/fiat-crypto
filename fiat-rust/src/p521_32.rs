...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_p521_addcarryx_u32(out1: &mut u32, out2: &mut fiat_p521_u1, arg1: fiat_p521_u1, arg2: u32, arg3: u32) -> () {
  let x1: u64 = (((arg1 as u64) + (arg2 as u64)) + (arg3 as u64));
  let x2: u32 = ((x1 & (0xffffffff as u64)) as u32);
  let x3: fiat_p521_u1 = ((x1 >> 32) as fiat_p521_u1);
  *out1 = x2;
  *out2 = x3;
}
...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_p521_subborrowx_u32(out1: &mut u32, out2: &mut fiat_p521_u1, arg1: fiat_p521_u1, arg2: u32, arg3: u32) -> () {
  let x1: i64 = (((arg2 as i64) - (arg1 as i64)) - (arg3 as i64));
  let x2: fiat_p521_i1 = ((x1 >> 32) as fiat_p521_i1);
...
pub fn fiat_p521_to_bytes(out1: &mut [u8; 66], arg1: &fiat_p521_tight_field_element) {
  ...
  fiat_p521_subborrowx_u32(&mut x39, &mut x40, x38, (0x0 as u32), (0x0 as u32));
  let mut x41: u32 = 0;
  let mut x42: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u28(&mut x41, &mut x42, 0x0, x1, (x39 & 0xfffffff));
  let mut x43: u32 = 0;
  let mut x44: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x43, &mut x44, x42, x3, (x39 & 0x7ffffff));
  let mut x45: u32 = 0;
  let mut x46: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u28(&mut x45, &mut x46, x44, x5, (x39 & 0xfffffff));
  let mut x47: u32 = 0;
  let mut x48: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x47, &mut x48, x46, x7, (x39 & 0x7ffffff));
  let mut x49: u32 = 0;
  let mut x50: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u28(&mut x49, &mut x50, x48, x9, (x39 & 0xfffffff));
  let mut x51: u32 = 0;
  let mut x52: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x51, &mut x52, x50, x11, (x39 & 0x7ffffff));
  let mut x53: u32 = 0;
  let mut x54: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x53, &mut x54, x52, x13, (x39 & 0x7ffffff));
  let mut x55: u32 = 0;
  let mut x56: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u28(&mut x55, &mut x56, x54, x15, (x39 & 0xfffffff));
  let mut x57: u32 = 0;
  let mut x58: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x57, &mut x58, x56, x17, (x39 & 0x7ffffff));
  let mut x59: u32 = 0;
  let mut x60: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u28(&mut x59, &mut x60, x58, x19, (x39 & 0xfffffff));
  let mut x61: u32 = 0;
  let mut x62: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x61, &mut x62, x60, x21, (x39 & 0x7ffffff));
  let mut x63: u32 = 0;
  let mut x64: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u28(&mut x63, &mut x64, x62, x23, (x39 & 0xfffffff));
  let mut x65: u32 = 0;
  let mut x66: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x65, &mut x66, x64, x25, (x39 & 0x7ffffff));
  let mut x67: u32 = 0;
  let mut x68: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x67, &mut x68, x66, x27, (x39 & 0x7ffffff));
  let mut x69: u32 = 0;
  let mut x70: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u28(&mut x69, &mut x70, x68, x29, (x39 & 0xfffffff));
  let mut x71: u32 = 0;
  let mut x72: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x71, &mut x72, x70, x31, (x39 & 0x7ffffff));
  let mut x73: u32 = 0;
  let mut x74: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u28(&mut x73, &mut x74, x72, x33, (x39 & 0xfffffff));
  let mut x75: u32 = 0;
  let mut x76: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x75, &mut x76, x74, x35, (x39 & 0x7ffffff));
  let mut x77: u32 = 0;
  let mut x78: fiat_p521_u1 = 0;
  fiat_p521_addcarryx_u27(&mut x77, &mut x78, x76, x37, (x39 & 0x7ffffff));
  let x79: u64 = ((x77 as u64) << 6);
  let x80: u32 = (x75 << 3);
  let x81: u64 = ((x73 as u64) << 7);
  let x82: u32 = (x71 << 4);
  let x83: u32 = (x67 << 5);
  let x84: u32 = (x65 << 2);
  let x85: u64 = ((x63 as u64) << 6);
  let x86: u32 = (x61 << 3);
  let x87: u64 = ((x59 as u64) << 7);
  let x88: u32 = (x57 << 4);
  let x89: u32 = (x53 << 5);
  let x90: u32 = (x51 << 2);
  let x91: u64 = ((x49 as u64) << 6);
  let x92: u32 = (x47 << 3);
  let x93: u64 = ((x45 as u64) << 7);
  let x94: u32 = (x43 << 4);
  let x95: u8 = ((x41 & (0xff as u32)) as u8);
  let x96: u32 = (x41 >> 8);
  let x97: u8 = ((x96 & (0xff as u32)) as u8);
  let x98: u32 = (x96 >> 8);
  let x99: u8 = ((x98 & (0xff as u32)) as u8);
  let x100: u8 = ((x98 >> 8) as u8);
  let x101: u32 = (x94 + (x100 as u32));
  ...
  let x108: u64 = (x93 + (x107 as u64));
  let x109: u8 = ((x108 & (0xff as u64)) as u8);
  let x110: u32 = ((x108 >> 8) as u32);
  ...
  let x117: u32 = (x92 + (x116 as u32));
  let x118: u8 = ((x117 & (0xff as u32)) as u8);
  let x119: u32 = (x117 >> 8);
  let x120: u8 = ((x119 & (0xff as u32)) as u8);
  let x121: u32 = (x119 >> 8);
  let x122: u8 = ((x121 & (0xff as u32)) as u8);
  let x123: u8 = ((x121 >> 8) as u8);
  let x124: u64 = (x91 + (x123 as u64));
  let x125: u8 = ((x124 & (0xff as u64)) as u8);
  let x126: u32 = ((x124 >> 8) as u32);
  let x127: u8 = ((x126 & (0xff as u32)) as u8);
  let x128: u32 = (x126 >> 8);
  let x129: u8 = ((x128 & (0xff as u32)) as u8);
  let x130: u32 = (x128 >> 8);
  let x131: u8 = ((x130 & (0xff as u32)) as u8);
  let x132: u8 = ((x130 >> 8) as u8);
  let x133: u32 = (x90 + (x132 as u32));
  let x134: u8 = ((x133 & (0xff as u32)) as u8);
  let x135: u32 = (x133 >> 8);
  let x136: u8 = ((x135 & (0xff as u32)) as u8);
  let x137: u32 = (x135 >> 8);
  let x138: u8 = ((x137 & (0xff as u32)) as u8);
  let x139: u8 = ((x137 >> 8) as u8);
  let x140: u32 = (x89 + (x139 as u32));
  let x141: u8 = ((x140 & (0xff as u32)) as u8);
  let x142: u32 = (x140 >> 8);
  let x143: u8 = ((x142 & (0xff as u32)) as u8);
  let x144: u32 = (x142 >> 8);
  let x145: u8 = ((x144 & (0xff as u32)) as u8);
  let x146: u8 = ((x144 >> 8) as u8);
  let x147: u8 = ((x55 & (0xff as u32)) as u8);
  let x148: u32 = (x55 >> 8);
  let x149: u8 = ((x148 & (0xff as u32)) as u8);
  let x150: u32 = (x148 >> 8);
  let x151: u8 = ((x150 & (0xff as u32)) as u8);
  let x152: u8 = ((x150 >> 8) as u8);
  let x153: u32 = (x88 + (x152 as u32));
  let x154: u8 = ((x153 & (0xff as u32)) as u8);
  let x155: u32 = (x153 >> 8);
  let x156: u8 = ((x155 & (0xff as u32)) as u8);
  let x157: u32 = (x155 >> 8);
  let x158: u8 = ((x157 & (0xff as u32)) as u8);
  let x159: u8 = ((x157 >> 8) as u8);
  let x160: u64 = (x87 + (x159 as u64));
  let x161: u8 = ((x160 & (0xff as u64)) as u8);
  let x162: u32 = ((x160 >> 8) as u32);
  let x163: u8 = ((x162 & (0xff as u32)) as u8);
  let x164: u32 = (x162 >> 8);
  let x165: u8 = ((x164 & (0xff as u32)) as u8);
  let x166: u32 = (x164 >> 8);
  let x167: u8 = ((x166 & (0xff as u32)) as u8);
  let x168: u8 = ((x166 >> 8) as u8);
  let x169: u32 = (x86 + (x168 as u32));
  let x170: u8 = ((x169 & (0xff as u32)) as u8);
  let x171: u32 = (x169 >> 8);
  let x172: u8 = ((x171 & (0xff as u32)) as u8);
  let x173: u32 = (x171 >> 8);
  let x174: u8 = ((x173 & (0xff as u32)) as u8);
  let x175: u8 = ((x173 >> 8) as u8);
  let x176: u64 = (x85 + (x175 as u64));
  let x177: u8 = ((x176 & (0xff as u64)) as u8);
  let x178: u32 = ((x176 >> 8) as u32);
  let x179: u8 = ((x178 & (0xff as u32)) as u8);
  let x180: u32 = (x178 >> 8);
  let x181: u8 = ((x180 & (0xff as u32)) as u8);
  let x182: u32 = (x180 >> 8);
  let x183: u8 = ((x182 & (0xff as u32)) as u8);
  let x184: u8 = ((x182 >> 8) as u8);
  let x185: u32 = (x84 + (x184 as u32));
  let x186: u8 = ((x185 & (0xff as u32)) as u8);
  let x187: u32 = (x185 >> 8);
  let x188: u8 = ((x187 & (0xff as u32)) as u8);
  let x189: u32 = (x187 >> 8);
  let x190: u8 = ((x189 & (0xff as u32)) as u8);
  let x191: u8 = ((x189 >> 8) as u8);
  let x192: u32 = (x83 + (x191 as u32));
  let x193: u8 = ((x192 & (0xff as u32)) as u8);
  let x194: u32 = (x192 >> 8);
  let x195: u8 = ((x194 & (0xff as u32)) as u8);
  let x196: u32 = (x194 >> 8);
  let x197: u8 = ((x196 & (0xff as u32)) as u8);
  let x198: u8 = ((x196 >> 8) as u8);
  let x199: u8 = ((x69 & (0xff as u32)) as u8);
  let x200: u32 = (x69 >> 8);
  let x201: u8 = ((x200 & (0xff as u32)) as u8);
  let x202: u32 = (x200 >> 8);
  let x203: u8 = ((x202 & (0xff as u32)) as u8);
  let x204: u8 = ((x202 >> 8) as u8);
  let x205: u32 = (x82 + (x204 as u32));
  let x206: u8 = ((x205 & (0xff as u32)) as u8);
  let x207: u32 = (x205 >> 8);
  let x208: u8 = ((x207 & (0xff as u32)) as u8);
  let x209: u32 = (x207 >> 8);
  let x210: u8 = ((x209 & (0xff as u32)) as u8);
  let x211: u8 = ((x209 >> 8) as u8);
  let x212: u64 = (x81 + (x211 as u64));
  let x213: u8 = ((x212 & (0xff as u64)) as u8);
  let x214: u32 = ((x212 >> 8) as u32);
  let x215: u8 = ((x214 & (0xff as u32)) as u8);
  let x216: u32 = (x214 >> 8);
  let x217: u8 = ((x216 & (0xff as u32)) as u8);
  let x218: u32 = (x216 >> 8);
  let x219: u8 = ((x218 & (0xff as u32)) as u8);
  let x220: u8 = ((x218 >> 8) as u8);
  let x221: u32 = (x80 + (x220 as u32));
  let x222: u8 = ((x221 & (0xff as u32)) as u8);
  let x223: u32 = (x221 >> 8);
  let x224: u8 = ((x223 & (0xff as u32)) as u8);
  let x225: u32 = (x223 >> 8);
  let x226: u8 = ((x225 & (0xff as u32)) as u8);
  let x227: u8 = ((x225 >> 8) as u8);
  let x228: u64 = (x79 + (x227 as u64));
  let x229: u8 = ((x228 & (0xff as u64)) as u8);
  let x230: u32 = ((x228 >> 8) as u32);
  let x231: u8 = ((x230 & (0xff as u32)) as u8);
  let x232: u32 = (x230 >> 8);
  let x233: u8 = ((x232 & (0xff as u32)) as u8);
  let x234: u32 = (x232 >> 8);
  let x235: u8 = ((x234 & (0xff as u32)) as u8);
  let x236: fiat_p521_u1 = ((x234 >> 8) as fiat_p521_u1);
  out1[0] = x95;
  out1[1] = x97;
  out1[2] = x99;
  out1[3] = x102;
