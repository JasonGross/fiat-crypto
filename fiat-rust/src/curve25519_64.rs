/* Autogenerated: src/ExtractionOCaml/unsaturated_solinas --lang=Rust 25519 5 '2^255 - 19' 64 carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes carry_scmul121666 */
...
pub fn fiat_25519_subborrowx_u51(out1: &mut u64, out2: &mut fiat_25519_u1, arg1: fiat_25519_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: fiat_25519_i1 = (((x1 as i64) >> 51) as fiat_25519_i1);
  let x3: u64 = (((x1 as i64) as u64) & 0x7ffffffffffff);
  *out1 = x3;
...
pub fn fiat_25519_cmovznz_u64(out1: &mut u64, arg1: fiat_25519_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: u64 = ((((0x0 as fiat_25519_i2) - (x1 as fiat_25519_i2)) as u64) & 0xffffffffffffffff);
...
pub fn fiat_25519_carry_mul(out1: &mut [u64; 5], arg1: &[u64; 5], arg2: &[u64; 5]) -> () {
  ...
  let x28: u64 = ((x26 as u64) & 0x7ffffffffffff);
...
pub fn fiat_25519_carry_square(out1: &mut [u64; 5], arg1: &[u64; 5]) -> () {
  ...
  let x26: u64 = ((x24 as u64) & 0x7ffffffffffff);
