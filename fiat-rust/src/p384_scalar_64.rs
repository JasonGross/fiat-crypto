...
pub fn fiat_p384_scalar_sub(out1: &mut fiat_p384_scalar_montgomery_domain_field_element, arg1: &fiat_p384_scalar_montgomery_domain_field_element, arg2: &fiat_p384_scalar_montgomery_domain_field_element) {
  ...
  let mut x13: u64 = 0;
  let mut x14: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x13, &mut x14, x12, (0x0 as u64), (0x0 as u64));
  let mut x15: u64 = 0;
  let mut x16: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x15, &mut x16, 0x0, x1, (x13 & 0xecec196accc52973));
  let mut x17: u64 = 0;
  let mut x18: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x17, &mut x18, x16, x3, (x13 & 0x581a0db248b0a77a));
  let mut x19: u64 = 0;
  let mut x20: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x19, &mut x20, x18, x5, (x13 & 0xc7634d81f4372ddf));
  let mut x21: u64 = 0;
  let mut x22: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x21, &mut x22, x20, x7, x13);
  let mut x23: u64 = 0;
  let mut x24: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x23, &mut x24, x22, x9, x13);
  let mut x25: u64 = 0;
  let mut x26: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x25, &mut x26, x24, x11, x13);
  out1[0] = x15;
  out1[1] = x17;
  out1[2] = x19;
  out1[3] = x21;
...
pub fn fiat_p384_scalar_divstep(out1: &mut u64, out2: &mut [u64; 7], out3: &mut [u64; 7], out4: &mut [u64; 6], out5: &mut [u64; 6], arg1: u64, arg2: &[u64; 7], arg3: &[u64; 7], arg4: &[u64; 6], arg5: &[u64; 6]) {
  ...
  let mut x85: u64 = 0;
  let mut x86: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x85, &mut x86, x84, (0x0 as u64), (0x0 as u64));
  let mut x87: u64 = 0;
  let mut x88: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x87, &mut x88, 0x0, x73, (x85 & 0xecec196accc52973));
  let mut x89: u64 = 0;
  let mut x90: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x89, &mut x90, x88, x75, (x85 & 0x581a0db248b0a77a));
  let mut x91: u64 = 0;
  let mut x92: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x91, &mut x92, x90, x77, (x85 & 0xc7634d81f4372ddf));
  let mut x93: u64 = 0;
  let mut x94: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x93, &mut x94, x92, x79, x85);
  let mut x95: u64 = 0;
  let mut x96: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x95, &mut x96, x94, x81, x85);
  let mut x97: u64 = 0;
  let mut x98: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x97, &mut x98, x96, x83, x85);
  let mut x99: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x99, x3, (arg5[0]), x87);
  let mut x100: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x100, x3, (arg5[1]), x89);
  let mut x101: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x101, x3, (arg5[2]), x91);
  let mut x102: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x102, x3, (arg5[3]), x93);
  let mut x103: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x103, x3, (arg5[4]), x95);
  let mut x104: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x104, x3, (arg5[5]), x97);
  let x105: fiat_p384_scalar_u1 = ((x28 & (0x1 as u64)) as fiat_p384_scalar_u1);
  let mut x106: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x106, x105, (0x0 as u64), x7);
  let mut x107: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x107, x105, (0x0 as u64), x8);
  let mut x108: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x108, x105, (0x0 as u64), x9);
  let mut x109: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x109, x105, (0x0 as u64), x10);
  let mut x110: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x110, x105, (0x0 as u64), x11);
  let mut x111: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x111, x105, (0x0 as u64), x12);
  let mut x112: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x112, x105, (0x0 as u64), x13);
  let mut x113: u64 = 0;
  let mut x114: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x113, &mut x114, 0x0, x28, x106);
  let mut x115: u64 = 0;
  let mut x116: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x115, &mut x116, x114, x29, x107);
  let mut x117: u64 = 0;
  let mut x118: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x117, &mut x118, x116, x30, x108);
  let mut x119: u64 = 0;
  let mut x120: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x119, &mut x120, x118, x31, x109);
  let mut x121: u64 = 0;
  let mut x122: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x121, &mut x122, x120, x32, x110);
  let mut x123: u64 = 0;
  let mut x124: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x123, &mut x124, x122, x33, x111);
  let mut x125: u64 = 0;
  let mut x126: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x125, &mut x126, x124, x34, x112);
  let mut x127: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x127, x105, (0x0 as u64), x35);
  let mut x128: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x128, x105, (0x0 as u64), x36);
  let mut x129: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x129, x105, (0x0 as u64), x37);
  let mut x130: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x130, x105, (0x0 as u64), x38);
  let mut x131: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x131, x105, (0x0 as u64), x39);
  let mut x132: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x132, x105, (0x0 as u64), x40);
  let mut x133: u64 = 0;
  let mut x134: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x133, &mut x134, 0x0, x99, x127);
  let mut x135: u64 = 0;
  let mut x136: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x135, &mut x136, x134, x100, x128);
  let mut x137: u64 = 0;
  let mut x138: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x137, &mut x138, x136, x101, x129);
  let mut x139: u64 = 0;
  let mut x140: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x139, &mut x140, x138, x102, x130);
  let mut x141: u64 = 0;
  let mut x142: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x141, &mut x142, x140, x103, x131);
  let mut x143: u64 = 0;
  let mut x144: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x143, &mut x144, x142, x104, x132);
  let mut x145: u64 = 0;
  let mut x146: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x145, &mut x146, 0x0, x133, 0xecec196accc52973);
  let mut x147: u64 = 0;
  let mut x148: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x147, &mut x148, x146, x135, 0x581a0db248b0a77a);
  let mut x149: u64 = 0;
  let mut x150: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x149, &mut x150, x148, x137, 0xc7634d81f4372ddf);
  let mut x151: u64 = 0;
  let mut x152: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x151, &mut x152, x150, x139, 0xffffffffffffffff);
  let mut x153: u64 = 0;
  let mut x154: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x153, &mut x154, x152, x141, 0xffffffffffffffff);
  let mut x155: u64 = 0;
  let mut x156: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x155, &mut x156, x154, x143, 0xffffffffffffffff);
  let mut x157: u64 = 0;
  let mut x158: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_subborrowx_u64(&mut x157, &mut x158, x156, (x144 as u64), (0x0 as u64));
  let mut x159: u64 = 0;
  let mut x160: fiat_p384_scalar_u1 = 0;
  fiat_p384_scalar_addcarryx_u64(&mut x159, &mut x160, 0x0, x6, (0x1 as u64));
  let x161: u64 = ((x113 >> 1) | ((x115 << 63) & 0xffffffffffffffff));
  let x162: u64 = ((x115 >> 1) | ((x117 << 63) & 0xffffffffffffffff));
  let x163: u64 = ((x117 >> 1) | ((x119 << 63) & 0xffffffffffffffff));
  let x164: u64 = ((x119 >> 1) | ((x121 << 63) & 0xffffffffffffffff));
  let x165: u64 = ((x121 >> 1) | ((x123 << 63) & 0xffffffffffffffff));
  let x166: u64 = ((x123 >> 1) | ((x125 << 63) & 0xffffffffffffffff));
  let x167: u64 = ((x125 & 0x8000000000000000) | (x125 >> 1));
  let mut x168: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x168, x66, x53, x41);
  let mut x169: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x169, x66, x55, x43);
  let mut x170: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x170, x66, x57, x45);
  let mut x171: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x171, x66, x59, x47);
  let mut x172: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x172, x66, x61, x49);
  let mut x173: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x173, x66, x63, x51);
  let mut x174: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x174, x158, x145, x133);
  let mut x175: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x175, x158, x147, x135);
  let mut x176: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x176, x158, x149, x137);
  let mut x177: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x177, x158, x151, x139);
  let mut x178: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x178, x158, x153, x141);
  let mut x179: u64 = 0;
  fiat_p384_scalar_cmovznz_u64(&mut x179, x158, x155, x143);
  *out1 = x159;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
